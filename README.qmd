...
Then you can try execute this command :   
...
This package uses non-CRAN and Bioc dependencies so it may cause some problems.

If you have an error in the package's installation of the dependencies, you can do this command before in the console :   
