...
# Pathway collections 
pathway_collections <- "CP:KEGG_LEGACY"  # You can add as many pathways as you want it will only create more plots
...
(installation precisions on the website)
...
If you want to add a circular/oval shape to circle the different genotypes of samples, use the `fviz_pca_ind` function from the `factoextra` package.
